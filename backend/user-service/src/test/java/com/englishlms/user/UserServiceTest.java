...
class UserServiceTest {
    ...
    @Test
    @DisplayName("Đổi mật khẩu thành công - FR-06")
    void changePassword_Success() {
        com.englishlms.user.dto.ChangePasswordRequest req = com.englishlms.user.dto.ChangePasswordRequest.builder()
        ...
        UserResponse res = userService.changePassword("student@gmail.com", req);
    ...
    @Test
    @DisplayName("Đổi mật khẩu thất bại - Sai mật khẩu hiện tại")
    void changePassword_WrongCurrentPassword_ThrowsBadRequest() {
        ...
        assertThrows(com.englishlms.user.exception.BadRequestException.class,
                () -> userService.changePassword("student@gmail.com", req));
        verify(userRepository, never()).save(any(User.class));
    }

    @Test
    @DisplayName("Đổi mật khẩu thất bại - Mật khẩu mới và xác nhận không khớp")
