...
print(f"🚀 Bắt đầu Smoke Test cho English LMS trên Gateway: {GATEWAY_URL}\n")
...
if test_course_id:
    try:
        ...
        # Check summary protection (content must be None/empty in summary)
...
if student_token:
    try:
        ...
        # Should be 200 (if key/mock available) or 503/500/429 (handled gracefully)
...
print("\n🎉 TOÀN BỘ SMOKE TEST HOÀN THÀNH XUẤT SẮC!")
