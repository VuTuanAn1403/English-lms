...
| `GET` | `/api/v1/users/my-info` | Authenticated | Lấy thông tin cá nhân |
...
- **Response 200 OK**:
  ```json
  {
    ...
    "data": {
      ...
      "generalFeedback": "Đoạn văn có lỗi chia thì quá khứ đơn.",
      "errorType": "Grammar / Verb Tense",
      "detailedExplanation": "Trạng từ yesterday chỉ thời gian quá khứ, động từ go phải chia dạng quá khứ là went.",
      "cefrLevel": "A2",
      "grammarScore": 70,
      "correctedSentences": [
