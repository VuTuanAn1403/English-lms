...
public class QuizPromptStrategy implements PromptStrategy {
    ...
    public String getSystemInstruction() {
        return """
            ...
            Your task is to generate high-quality multiple choice English quiz questions based on specified lesson topics, CEFR level, skill target, and difficulty.
    ...
    public Prompt buildPrompt(Map<String, Object> params) {
        ...
        String userPrompt = String.format("""
            ...
            """, numberOfQuestions, lesson, cefrLevel, skillTarget, difficulty);
