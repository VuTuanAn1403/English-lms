...
class JwtUtilTest {
    ...
    @Test
    @DisplayName("Token hợp lệ - Validate thành công và trích xuất email, role & userId")
    void validateToken_ValidToken_ReturnsTrue() {
        String userIdStr = java.util.UUID.randomUUID().toString();
        ...
        assertEquals(userIdStr, jwtUtil.getUserIdFromToken(token));
    }
